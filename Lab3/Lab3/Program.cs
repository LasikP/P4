...
var join2 = con.Query<Region, Territories, Region>("SELECT * FROM Region AS r JOIN Territories AS t on r.RegionID = t.RegionID WHERE TerritoryDescription LIKE 'E%'  ",
    (region, territories) =>
    {
